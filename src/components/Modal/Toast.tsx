...
const Toast=({ msg, closed, isVisible }: any)=>{
    ...
    return (
        <SetPosition className={`fixed toast-box ${isVisible ? 'visible' : ''}`}>
            <div className="w-72 relative flex items-center justify-between max-w-xs p-4 bg-white border rounded-md shadow-sm overflow-hidden">
                <div className="flex items-center">
                    ...
                    <p className="ml-3 text-sm font-bold text-green-600">{msg}</p>
                </div>
